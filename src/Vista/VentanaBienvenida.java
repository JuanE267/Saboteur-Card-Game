...
public class VentanaBienvenida extends JFrame {
    ...
    private void pedirDatosParaUnirse() throws RMIMVCException, RemoteException {
        ...
        String ipServidor = JOptionPane.showInputDialog(
                null,
                "Ingrese la IP del servidor (PC donde se creo la partida)",
                "127.0.0.1"
        );
        ...
        String ipCliente = (String) JOptionPane.showInputDialog(
                null,
                "Seleccione su propia IP (la de esta maquina)", "IP del cliente",
                JOptionPane.QUESTION_MESSAGE,
                null,
                ips.toArray(),   // muestra las IPs disponibles en esta maquina
                null
        );
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                    "Error de conexion con el servidor.\nVerifica que el servidor este corriendo y la IP sea correcta.\n\n" + e.getMessage(),
